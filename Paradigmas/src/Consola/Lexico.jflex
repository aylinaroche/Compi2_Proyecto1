...
"switch" {return new Symbol(sym.interrumpir, yycolumn, yyline,new String(yytext()));}
"case" {return new Symbol(sym.caso, yycolumn, yyline,new String(yytext()));}
"default" {return new Symbol(sym.defecto, yycolumn, yyline,new String(yytext()));}
"while" {return new Symbol(sym.mientras, yycolumn, yyline,new String(yytext()));}
"do" {return new Symbol(sym.hacer, yycolumn, yyline,new String(yytext()));}
"for" {return new Symbol(sym.para, yycolumn, yyline,new String(yytext()));}
