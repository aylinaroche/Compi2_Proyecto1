    ...
    public static void archivos() {
        try {
            Analizar(""
                    ...
                    //                    + "        imprimir(\"Resultado de operacion : \" + i)?\n"
                    //                    + "        \n"
                    ...
                    + "        \n"
                    + "        imprimir(estudiante1.nombre + \" tiene \" + estudiante1.edad + \" años, vive en: \" + estudiante1.d.direccion)?\n"
                    + "        imprimir(estudiante2.nombre + \" tiene \" + estudiante2.edad + \" años, vide en: \" + estudiante2.d.direccion)?\n"
                    + "        imprimir(estudiante3.nombre + \" tiene \" + estudiante3.edad + \" años, vide en: \" + estudiante3.d.direccion)?\n"
                    //                    + "        \n"
                    + "        \n"
                    + "    }\n"
                    + "    \n"
                    ...
                    + "    var detalle d:publico?\n"
                    + "    \n"
                    + "	cadena estudiante():publico{\n"
                    + "        d = nuevo detalle()?\n"
                    + "    }\n"
                    + "    \n"
                    + "    \n"
                    ...
                    + "    \n"
                    + "    \n"
                    + "    vacio siguiente_semestre():publico{\n"
                    + "        edad = edad + 1?\n"
                    + "    }\n"
                    + "    \n"
                    + "    vacio ingresar_detalle(cadena dir, cadena tel, cadena dpi):publico{\n"
                    + "        d.direccion = dir?\n"
                    + "        d.telefono = tel?\n"
                    + "        d.dpi = dpi?\n"
                    + "    }\n"
    ...
    public static void objetoFuncion() {
        try {
            Analizar(""
                    ...
                    + "                     var entero num1 = 5?"
                    + "                     var entero num2 = 6?"
                    //+ "                   imprimir(profe1.saludo().cursos())?\n
                    +"                      llamar profe1.saludo(num1).cursos(num2)?"
                    + "			}\n"
                    + "	}\n"
                    ...
                    + "			\n"
                    + "			\n"
                    + "                 curso saludo(entero num1):publico{\n"
                  //  + "                         var Estudiante estu1 = nuevo Estudiante()? \n"
                    + "				var curso curso = nuevo curso()?\n"
                    + "				\n"
                    //+ "				llamar curso.saludo()?\n"
                    + "				imprimir(\"estoy en metodo de profesor = \"+ num1)?\n"
                    + "                         retornar curso?\n"
                    + "			}\n"
                    + "}\n"
                    + "		ALS Estudiante:publico {\n"
                    ...
                    + "				\n"
                    + "				\n"
                    + "				vacio cursos(entero num2):publico{\n"
                    + "                                 imprimir(\"es el codigo del curso \"+codigo)?\n"
                    + "					imprimir(\"estoy en el metodo de curso = \"+num2)?\n"
                    + "				}\n"
                    + "                 }"
                    + "");
        } catch (Exception ex) {
